...
pricing_method new_pricing_method_(price_f, pp_f, prices_f, delta_f, gamma_f,
  theta_f, rho_f, vega_f, impl_vol_f, delete_f, pricing_data, void*);

int pm_option_price(pricing_method, option_data, double S, result);
int pm_option_price_precision(pricing_method, option_data, double V, double S, result);
