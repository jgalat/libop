...
class Dopri5 {
  public:
    ...
    int run(unsigned n, /* dimension of the system <= UINT_MAX-1*/
  ...
  private:
    ...
    long nfcn, nstep, naccpt, nrejct;

    double hout, xold, xout;
    unsigned nrds, *indir;
    double *yy1, *k1, *k2, *k3, *k4, *k5, *k6, *ysti, *yold;
    double *rcont1, *rcont2, *rcont3, *rcont4, *rcont5;

    // Root values
    double *val_t0, *val_t1, *val_e;
    int *neg, *discont, *zero;
